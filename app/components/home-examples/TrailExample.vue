...
import { Bike, Clock, Flame, Route as RouteIcon } from "lucide-vue-next";
  ...
  <ExampleCard class="aspect-square" :stagger="5">
    ...
    >
      ...
      <div class="grid grid-cols-3 gap-3 text-center">
        <div>
          <div
            class="text-muted-foreground mb-0.5 flex items-center justify-center gap-1"
          >
    ...
    <ClientOnly>
      <Map :center="[-73.97, 40.782]" :zoom="11.8">
        ...
        <MapMarker :longitude="start[0]" :latitude="start[1]">
          <MarkerContent>
            <div
              class="size-3 rounded-full border-2 border-white bg-emerald-500 shadow-lg"
            />
          </MarkerContent>
        </MapMarker>
        <MapMarker :longitude="end[0]" :latitude="end[1]">
          <MarkerContent>
            <div
              class="size-3 rounded-full border-2 border-white bg-red-500 shadow-lg"
            />
          </MarkerContent>
        </MapMarker>
      </Map>
